...
public class MainPageTest {
    ...
    public void checkPushButtonAccordion() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            Assert.assertEquals("Ответ на " + (i + 1) + " вопрос не соответствует требованиям", array[i], result);
        }
    }
